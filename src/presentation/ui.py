...
from src.application.core.constants import AREA_CODE_MAP, SIGUNGU_CODE_MAP, PAGE_SIZE
    ...
    with gr.Blocks(
        ...
        with gr.Column(visible=False) as results_area:
            ...
            with gr.Row(variant="panel"):
                ...
                page_buttons = [
                    gr.Button(str(i), visible=False, size="sm") for i in range(1, 6)
                ]
        ...
        with gr.Accordion(
            "감성 분석", open=False, visible=False
        ) as sentiment_accordion:
            with gr.Row():
        ...
        update_medium_cat_with_map = functools.partial(
            callbacks.update_medium_cat, all_festival_categories=ALL_FESTIVAL_CATEGORIES
        )
        ...
        update_small_cat_with_map = functools.partial(
            callbacks.update_small_cat, all_festival_categories=ALL_FESTIVAL_CATEGORIES
        )
        ...
        search_btn.click(
            fn=event_handlers.run_search_and_display,
            inputs=[
                area_dropdown,
                sigungu_dropdown,
                main_cat_dropdown,
        ...
        rank_festivals_btn.click(
            ...
            outputs=[results_state, festival_gallery, page_display]
            + page_buttons
            + [festival_ranking_report, total_pages_state],
        )
        ...
        for btn in page_buttons:
            btn.click(
                ...
                outputs=[festival_gallery, page_display] + page_buttons,
            )
        page_input.submit(
            fn=event_handlers.display_page,
        ...
        festival_gallery.select(
            fn=event_handlers.display_festival_details_and_precautions,
        ...
        for btn in rec_page_buttons:
            btn.click(
                ...
                outputs=[recommend_festivals_gallery, rec_page_display]
                + [*rec_page_buttons],
            )
