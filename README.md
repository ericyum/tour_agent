...
6. [**📋 2025년 새싹 해커톤 신청서**](#-2025년-새싹-해커톤-신청서)
7. [폴더 구조](#-폴더-구조-클린-아키텍처-매핑)
8. [시작하기](#-시작하기)
9. [기대 효과 및 가치](#-기대-효과-및-가치)
...
📄 **신청서 파일**: [`2025년 새싹 해커톤 AI 서비스 기획서 양식_최종.docx`](./2025년%20새싹%20해커톤%20AI%20서비스%20기획서%20양식_최종.docx)

해당 문서에는 다음과 같은 내용이 포함되어 있습니다:
- 📝 **서비스 기획 배경 및 목적**
- 🎯 **핵심 기능 및 차별점**
- 🛠️ **기술 스택 상세 설명**
- 📊 **예상 기대 효과 및 사업화 방안**
